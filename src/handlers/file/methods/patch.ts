...
/**
 * Request handler for patching an {@link File File} entity.
 * @param request The Express request object.
 * @param response The Express response object.
 * @param next The next middleware function.
 *
 * @description Patch an {@link File File} entity in the database based on the provided ID at params and request body,
