...
/**
 * Request handler for updating an {@link Folder Folder} entity.
 * @param request The Express request object.
 * @param response The Express response object.
 * @param next The next middleware function.
 *
 * @description Update an {@link Folder Folder} entity in the database based on the provided ID at params and request body,
